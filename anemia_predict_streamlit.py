...
st.title('Anemia Detection App :red_circle:')
...
with col1:
    red_pixel = st.slider('% Red Pixel', min_value=0.0, max_value=100.0, value=40.0, step=0.1)
    green_pixel = st.slider('% Green Pixel', min_value=0.0, max_value=100.0, value=30.0, step=0.1)

with col2:
    blue_pixel = st.slider('% Blue Pixel', min_value=0.0, max_value=100.0, value=25.0, step=0.1)
